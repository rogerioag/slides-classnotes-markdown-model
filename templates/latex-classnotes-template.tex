...
%  \includegraphics[trim=0.0cm 22cm 0.0cm 0.0cm, width=1.0\linewidth]{$banner-classnotes$}
%  % \vspace{-1.0cm}
%  \vfill
%\end{figure}
\usepackage[cc]{titlepic}
\titlepic{\includegraphics[width=1.0\textwidth]{$banner-classnotes$}}
$else$
%  \begin{figure}
%  \centering
%  \vspace{-1.0cm}
...
%\end{figure}
\usepackage[cc]{titlepic}
\titlepic{\includegraphics[width=1.0\textwidth]{../templates/logos/logo-utfpr.png}}
$endif$

\begin{document}

% Generate Classnote banner.
% \classnotebanner

%  \titlehead{\centering\includegraphics[width=1.0\linewidth]{$banner-classnotes$}}
%$if(banner-classnotes)$
%\begin{figure}
%  \centering
%  \vspace{-1.5cm}
...
%    \centering
%    \includegraphics[width=0.5\linewidth]{$banner-classnotes$}
%    \caption{scheme}
%    \end{figure}
%}
\maketitle
